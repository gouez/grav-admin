...
use Laser\Core\Migration\V6_4\Migration1619604605FixListingPricesUsage;
                    ...
                    'blocks' => [
                        [
                            ...
                            'slots' => [
                                ...
                                ['id' => $sortingSlotId, 'type' => 'image', 'slot' => 'right', 'config' => ['url' => ['source' => FieldConfig::SOURCE_STATIC, 'value' => 'http://laser.com/image.jpg'], 'productStreamSorting' => $sorting]],
                            ],
                        ],
                    ],
                ],
                [
                    ...
                    'blocks' => [
                        [
                            ...
                            'slots' => [
                                ['type' => 'text', 'slot' => 'left', 'config' => ['content' => ['source' => FieldConfig::SOURCE_STATIC, 'value' => $faker->realText()]]],
                                ['type' => 'image', 'slot' => 'right', 'config' => ['url' => ['source' => FieldConfig::SOURCE_STATIC, 'value' => 'http://laser.com/image.jpg']]],
                            ],
                        ],
                    ],
                ],
