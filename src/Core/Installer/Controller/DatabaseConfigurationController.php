...
use Laser\Core\Installer\Database\BlueGreenDeploymentService;
use Laser\Core\Maintenance\System\Exception\DatabaseSetupException;
use Laser\Core\Maintenance\System\Service\DatabaseConnectionFactory;
use Laser\Core\Maintenance\System\Service\JwtCertificateGenerator;
use Laser\Core\Maintenance\System\Service\SetupDatabaseAdapter;
use Laser\Core\Maintenance\System\Struct\DatabaseConnectionInformation;
    ...
    public function databaseConfiguration(Request $request): Response
    {
        ...
        try {
            ...
            if ($this->setupDatabaseAdapter->getTableCount($connection, $connectionInfo->getDatabaseName())) {
                ...
                return $this->renderInstaller('@Installer/installer/database-configuration.html.twig', [
                    'connectionInfo' => $connectionInfo,
                    'error' => $this->translator->trans('laser.installer.database-configuration_non_empty_database'),
                ]);
            }
            ...
            return $this->renderInstaller('@Installer/installer/database-configuration.html.twig', [
                'connectionInfo' => $connectionInfo,
                'error' => $this->translator->trans('laser.installer.database-configuration_error_required_fields'),
            ]);
        } catch (\Exception $e) {
            return $this->renderInstaller('@Installer/installer/database-configuration.html.twig', [
                'connectionInfo' => $connectionInfo,
