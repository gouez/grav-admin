...
use Laser\Core\Framework\Api\Controller\FallbackController;
...
class Kernel extends HttpKernel
{
     ...
     * @var string
     */
    protected $laserVersion;

    /**
     * @var string|null
     */
    protected $laserVersionRevision;
    ...
    protected function getCacheHash(): string
    {
        ...
        return md5((string) \json_encode([
            $this->cacheId,
            substr((string) $this->laserVersionRevision, 0, 8),
    ...
    {
        $laserSkipConnectionVariables = EnvironmentHelper::getVariable('SHOPWARE_SKIP_CONNECTION_VARIABLES', false);

        if ($laserSkipConnectionVariables) {
            return;
        }
