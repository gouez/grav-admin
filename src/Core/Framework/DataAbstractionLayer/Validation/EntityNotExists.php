...
namespace Laser\Core\Framework\DataAbstractionLayer\Validation;
...
class EntityNotExists extends Constraint
{
    ...
    public function __construct(array $options)
    {
        ...
        if (!($this->criteria instanceof Criteria)) {
            throw new InvalidOptionsException(sprintf('Option "criteria" must be an instance of Laser\Core\Framework\DataAbstractionLayer\Search\Criteria for constraint %s', self::class), ['criteria']);
        }
    }
