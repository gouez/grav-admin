...
namespace Laser\Core\Framework\App\Hmac\Guzzle;

use GuzzleHttp\Exception\InvalidArgumentException;
use GuzzleHttp\Exception\ServerException;
use Psr\Http\Message\RequestInterface;
use Psr\Http\Message\ResponseInterface;
use Laser\Core\Framework\App\AppLocaleProvider;
use Laser\Core\Framework\App\Hmac\RequestSigner;
...
class AuthMiddleware
{
    ...
    public function getDefaultHeaderRequest(RequestInterface $request, array $options): RequestInterface
    {
        ...
        return $request->withAddedHeader('sw-version', $this->laserVersion);
    }
