...
use Laser\Core\Framework\App\AppService;
...
use Laser\Core\Framework\App\Validation\ManifestValidator;
...
class RefreshAppCommand extends Command
{
    ...
    private function validateRefreshableApps(RefreshableAppDryRun $refreshableApps, LaserStyle $io, Context $context): int
    {
    ...
    private function grantPermissions(RefreshableAppDryRun $refreshableApps, LaserStyle $io): void
    {
        if (!$io->confirm(
            sprintf(
    ...
    private function grantPermissionsForApp(Manifest $app, LaserStyle $io, bool $install = true): void
    {
