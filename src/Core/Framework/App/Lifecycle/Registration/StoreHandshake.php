...
use Laser\Core\Framework\App\Exception\AppLicenseCouldNotBeVerifiedException;
...
{
    private const SBP_EXCEPTION_UNAUTHORIZED = 'LaserPlatformException-1';

    private const SBP_EXCEPTION_NO_LICENSE = 'LaserPlatformException-16';
