...
namespace Laser\Core\Framework\Script\Facade;
...
class ArrayFacade implements \IteratorAggregate, \ArrayAccess, \Countable
{
     ...
     */
    public function merge(array|\Laser\Core\Framework\Script\Facade\ArrayFacade $array): void
    {
     ...
     */
    public function replace(array|\Laser\Core\Framework\Script\Facade\ArrayFacade $array): void
    {
        if ($array instanceof ArrayFacade) {
            $array = $array->items;
        }
