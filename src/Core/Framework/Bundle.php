...
use Laser\Core\Framework\Adapter\Asset\AssetPackageService;
use Laser\Core\Framework\Adapter\Filesystem\PrefixFilesystem;
...
abstract class Bundle extends SymfonyBundle
{
    ...
    /**
     * Returns a list of all action event class references of this bundle. The events will be registered inside the `\Laser\Core\Framework\Event\BusinessEventRegistry`.
     *
