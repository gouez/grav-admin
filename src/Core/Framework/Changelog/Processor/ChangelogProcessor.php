...
namespace Laser\Core\Framework\Changelog\Processor;

use Laser\Core\Framework\Changelog\ChangelogFile;
use Laser\Core\Framework\Changelog\ChangelogFileCollection;
use Laser\Core\Framework\Changelog\ChangelogParser;
...
class ChangelogProcessor
{
    ...
    private function getPlatformRoot(): string
    {
        if (!isset($this->platformRoot)) {
            ...
            if ($composerJson === null || $composerJson['name'] !== 'laser/platform') {
