...
namespace Laser\Core\Framework\Plugin\Command\Lifecycle;
...
abstract class AbstractPluginLifecycleCommand extends Command
{
    ...
    protected function prepareExecution(
        ...
        $io->title('Laser Plugin Lifecycle Service');
    ...
    protected function handleClearCacheOption(InputInterface $input, LaserStyle $io, string $action): void
    {
