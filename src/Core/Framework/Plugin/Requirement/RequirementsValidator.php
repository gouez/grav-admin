...
use Laser\Core\Framework\Plugin\Composer\Factory;
use Laser\Core\Framework\Plugin\PluginCollection;
use Laser\Core\Framework\Plugin\PluginEntity;
use Laser\Core\Framework\Plugin\Requirement\Exception\ComposerNameMissingException;
use Laser\Core\Framework\Plugin\Requirement\Exception\ConflictingPackageException;
use Laser\Core\Framework\Plugin\Requirement\Exception\MissingRequirementException;
use Laser\Core\Framework\Plugin\Requirement\Exception\RequirementStackException;
use Laser\Core\Framework\Plugin\Requirement\Exception\VersionMismatchException;
...
class RequirementsValidator
{
    ...
    private Composer $laserProjectComposer;
    ...
    public function validateRequirements(PluginEntity $plugin, Context $context, string $method): void
    {
        ...
        $this->laserProjectComposer = $this->getComposer($this->projectDir);
    ...
    private function checkComposerDependencies(
        ...
        foreach ($packages as $package) {
            // Ignore Laser plugins. They are checked separately in `validateInstalledPlugins`
    ...
    {
        $packages = $this->laserProjectComposer->getRepositoryManager()->getLocalRepository()->getPackages();
