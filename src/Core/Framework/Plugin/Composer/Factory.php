...
namespace Laser\Core\Framework\Plugin\Composer;
...
class Factory
{
    public static function createComposer(string $composerJsonDir, ?IOInterface $composerIO = null): Composer
    {
        ...
        // This is a workaround to make sure that the laser platform package has the correct version
        if (($json['name'] ?? '') === 'laser/platform' && !isset($json['version']) && !EnvironmentHelper::hasVariable('COMPOSER_ROOT_VERSION')) {
