...
namespace Laser\Core\Framework\Migration\Command;

use Laser\Core\Framework\Adapter\Console\LaserStyle;
use Laser\Core\Framework\Log\Package;
use Laser\Core\Framework\Migration\Exception\MigrateException;
use Laser\Core\Framework\Migration\Exception\UnknownMigrationSourceException;
...
class MigrationCommand extends Command
{
    ...
    public function __construct(
        ...
        $this->loader = $loader;
        $this->laserVersion = $laserVersion;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($total > 0) {
            $this->cache->clear();
            $this->io->writeln('cleared the laser cache');
        }
