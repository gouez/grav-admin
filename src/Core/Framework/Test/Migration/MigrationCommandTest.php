...
use Laser\Core\Framework\Migration\Command\MigrationCommand;
use Laser\Core\Framework\Migration\Command\MigrationDestructiveCommand;
use Laser\Core\Framework\Migration\Exception\MigrateException;
...
class MigrationCommandTest extends TestCase
{
    ...
    public function testCommandMigrateCacheClearBehaviourWithoutMigrations(): void
    {
        ...
        $command = new MigrationCommand($loader, $cache, $this->getContainer()->getParameter('kernel.laser_version'));
    ...
    public function testCommandMigrateCacheClearBehaviourWithOneMigration(): void
    {
        ...
        $command = new MigrationCommand($this->getContainer()->get(MigrationCollectionLoader::class), $cache, $this->getContainer()->getParameter('kernel.laser_version'));
