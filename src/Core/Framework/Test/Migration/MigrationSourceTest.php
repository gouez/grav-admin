...
namespace Laser\Core\Framework\Test\Migration;

use PHPUnit\Framework\TestCase;
use Laser\Core\Framework\Migration\MigrationSource;
use Laser\Core\Framework\Test\TestCaseBase\KernelTestBehaviour;
use Laser\Core\Migration\V6_3\Migration1565270366PromotionSetGroupRule;
use Laser\Core\Migration\V6_3\Migration1565346846Promotion;
use Laser\Core\Migration\V6_3\Migration1566293076AddAutoIncrement;
use Laser\Core\Migration\V6_3\Migration1566460168UpdateTexts;
use Laser\Core\Migration\V6_3\Migration1566817701AddDisplayGroup;
use Laser\Core\Migration\V6_3\Migration1567431050ContactFormTemplate;
use Laser\Core\Migration\V6_3\Migration1568120239CmsSection;
use Laser\Core\Migration\V6_3\Migration1568120302CmsBlockUpdate;
use Laser\Core\Migration\V6_3\Migration1568645037AddEnqueueDbal;
use Laser\Core\Migration\V6_3\Migration1568901713PromotionDiscount;
use Laser\Core\Migration\V6_3\Migration1569403146ProductVisibilityUnique;
use Laser\Core\Migration\V6_3\Migration1570187167AddedAppConfig;
use Laser\Core\Migration\V6_3\Migration1570459127AddCmsSidebarLayout;
use Laser\Core\Migration\V6_3\Migration1570621541UpdateDefaultMailTemplates;
use Laser\Core\Migration\V6_3\Migration1570622696CustomerPasswordRecovery;
use Laser\Core\Migration\V6_3\Migration1570629862ClearCategoryBreadcrumbs;
use Laser\Core\Migration\V6_3\Migration1570684913ScheduleIndexer;
use Laser\Core\Migration\V6_3\Migration1571059598ChangeGreatBritainToUnitedKingdom;
...
class MigrationSourceTest extends TestCase
{
    ...
    {
        $pattern = $this->getContainer()->get('Laser\Core\Framework\Migration\MigrationSource.core.V6_3')->getNamespacePattern();
    ...
    public static function provideCoreRegexDataV6_3(): array
    {
        $cases = [
            ...
            ['Laser\Core\Migration\V6_3\Something\Migration1571059598ChangeGreatBritainToUnitedKingdom', false],
        ];
    ...
    public static function provideUnitTestData(): array
    {
        return [
            ['__NOPE__', false],
            ['Laser\Storefront\Migration\Migration1572858066UpdateDefaultCategorySeoUrlTemplate', false],
