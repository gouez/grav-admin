...
use Laser\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerCollection;
use Laser\Core\Content\Product\ProductDefinition;
use Laser\Core\Defaults;
use Laser\Core\DevOps\Environment\EnvironmentHelper;
use Laser\Core\Framework\Context;
use Laser\Core\Framework\DataAbstractionLayer\EntityRepository;
use Laser\Core\Framework\DataAbstractionLayer\Exception\InvalidAggregationQueryException;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\DateHistogramAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\FilterAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\TermsAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\AvgAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\CountAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\EntityAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MaxAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MinAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\StatsAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\SumAggregation;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Bucket\Bucket;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Bucket\DateHistogramResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Bucket\TermsResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\AvgResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\CountResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\EntityResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\MaxResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\MinResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\StatsResult;
use Laser\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\SumResult;
...
use Laser\Core\Framework\Test\DataAbstractionLayer\Search\Util\DateHistogramCase;
...
class EntityAggregatorTest extends TestCase
{
    ...
    public function testAggregateNonExistingShouldFail(): void
    {
        ...
        $this->expectExceptionMessage('Aggregation of type Laser\Core\Framework\Test\DataAbstractionLayer\Search\TestAggregation not supported');
