...
namespace Laser\Core\Framework\Test\DataAbstractionLayer\Write;
...
use Laser\Core\Framework\DataAbstractionLayer\Write\Command\WriteTypeIntendException;
...
class WriterTest extends TestCase
{
        ...
        $this->getWriter()->insert(
            ...
            [
                [
                    ...
                    'tax' => ['name' => 'test', 'taxRate' => 5],
                    'manufacturer' => ['id' => Uuid::randomHex(), 'link' => 'https://laser.com', 'name' => 'laser AG'],
                    'mode' => 0,
                    'lastStock' => true,
                    'crossbundlelook' => 1,
                    'notification' => true,
    ...
    public function testUpdate(): void
    {
        ...
        static::assertSame('http://www.laser.com', $productManufacturer['link']);
    }
