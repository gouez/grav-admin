...
namespace Laser\Core\Framework\Test\Api\Controller;
...
use Laser\Core\Framework\Api\EventListener\Acl\CreditOrderLineItemListener;
...
use Laser\Core\Framework\Test\TestCaseHelper\TestUser;
...
class SalesChannelProxyControllerTest extends TestCase
{
    ...
    public function testSwitchCustomerWithoutSalesChannelId(): void
    {
        ...
        $customerId = $this->createCustomer($salesChannelContext, 'info@example.com', 'laser');
