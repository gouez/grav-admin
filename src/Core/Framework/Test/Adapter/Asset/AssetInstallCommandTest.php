...
namespace Laser\Core\Framework\Test\Adapter\Asset;

use League\Flysystem\FilesystemOperator;
use PHPUnit\Framework\TestCase;
use Laser\Core\Framework\Adapter\Asset\AssetInstallCommand;
...
class AssetInstallCommandTest extends TestCase
{
    ...
    public function testItInstallsAppAssets(): void
    {
        ...
        $filesystem = $this->getContainer()->get('laser.filesystem.asset');
