...
use Laser\Core\Framework\Store\Exception\ExtensionInstallException;
use Laser\Core\Framework\Store\Exception\ExtensionNotFoundException;
use Laser\Core\Framework\Store\Exception\ExtensionThemeStillInUseException;
use Laser\Core\Framework\Store\Services\ExtensionLifecycleService;
...
class ExtensionLifecycleServiceTest extends TestCase
{
    ...
    public function testDeleteAppWithDifferentName(): void
    {
        ...
        $oldName = $this->getContainer()->getParameter('laser.app_dir') . '/TestAppTheme';
        $newName = $this->getContainer()->getParameter('laser.app_dir') . '/some-random-folder-name';
