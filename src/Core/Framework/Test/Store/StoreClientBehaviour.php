...
namespace Laser\Core\Framework\Test\Store;
...
trait StoreClientBehaviour
{
    ...
    public function getStoreRequestHandler(): MockHandler
    {
        ...
        $handler = $this->getContainer()->get('laser.store.mock_handler');
    ...
    {
        /** @var MockHandler $handler */
        $handler = $this->getContainer()->get('laser.frw.mock_handler');
    ...
    {
        $version = $this->getContainer()->getParameter('kernel.laser_version');
