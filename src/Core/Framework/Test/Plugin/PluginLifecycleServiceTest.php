...
class PluginLifecycleServiceTest extends TestCase
{
    ...
    public function testRemoveMigrationsCannotRemoveLaserMigrations(): void
    {
        $this->removeMigrationsCannotRemoveLaserMigrations($this->context);
    }
    ...
    public function testRemoveMigrationsCannotRemoveLaserMigrationsWithNonStandardLanguage(): void
    {
        $this->removeMigrationsCannotRemoveLaserMigrations($this->createNonStandardLanguageContext());
    }
    ...
    private function removeMigrationsCannotRemoveLaserMigrations(Context $context): void
    {
        $this->pluginService->refreshPlugins($context, new NullIO());
        ...
        $_SERVER['FAKE_MIGRATION_NAMESPACE'] = 'Laser\\Core';
