...
namespace Laser\Core\Framework\Test\Plugin\Requirement;
...
use Laser\Core\TestBootstrapper;
use Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter;

/**
 * @internal
 *
 * @covers \Laser\Core\Framework\Plugin\Requirement\RequirementsValidator
 */
class RequirementsValidatorTest extends TestCase
{
    ...
    public function testValidateRequirementsDoNotMatch(): void
    {
        ...
        static::assertContains('laser/platform', $packages);
