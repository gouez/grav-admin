...
namespace Laser\Core\Framework\Test\Plugin\KernelPluginLoader;

use Composer\Autoload\ClassLoader;
use PHPUnit\Framework\TestCase;
use Laser\Core\Framework\Plugin;
use Laser\Core\Framework\Plugin\Exception\KernelPluginLoaderException;
...
use Laser\Core\Framework\Test\Plugin\_fixture\bundles\GizmoBundle;
use Laser\Core\Framework\Test\Plugin\PluginIntegrationTestBehaviour;
...
class StaticKernelPluginLoaderTest extends TestCase
{
    ...
    public function testExpectExceptionWithFakePlugin(): void
    {
        ...
        $this->expectException(KernelPluginLoaderException::class);
        $this->expectExceptionMessage('Failed to load plugin "SwagTest". Reason: Plugin class "SwagTest\SwagTestFake" must extend "Laser\Core\Framework\Plugin"');
        $loader->initializePlugins(TEST_PROJECT_DIR);
    }
