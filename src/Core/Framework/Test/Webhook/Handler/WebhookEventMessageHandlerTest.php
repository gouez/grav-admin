...
namespace Laser\Core\Framework\Test\Webhook\Handler;
...
use Laser\Core\Framework\Webhook\Handler\WebhookEventMessageHandler;
...
class WebhookEventMessageHandlerTest extends TestCase
{
    ...
    public function testSendSuccessful(): void
    {
        ...
        static::assertTrue($request->hasHeader('laser-shop-signature'));
        static::assertEquals(
