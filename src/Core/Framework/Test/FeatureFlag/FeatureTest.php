...
namespace Laser\Core\Framework\Test\FeatureFlag;

use PHPUnit\Framework\TestCase;
use Laser\Core\Framework\Adapter\Twig\Extension\FeatureFlagExtension;
...
class FeatureTest extends TestCase
{
    ...
    public function testConfigGetAllReturnsAllAndTracksState(): void
    {
        ...
        $featureFlags = array_keys($this->getContainer()->getParameter('laser.feature.flags'));
