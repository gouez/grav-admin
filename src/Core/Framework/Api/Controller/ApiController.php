...
use Laser\Core\Framework\Api\Converter\ApiVersionConverter;
use Laser\Core\Framework\Api\Converter\Exceptions\ApiConversionException;
use Laser\Core\Framework\Api\Exception\InvalidVersionNameException;
use Laser\Core\Framework\Api\Exception\LiveVersionDeleteException;
use Laser\Core\Framework\Api\Exception\MissingPrivilegeException;
use Laser\Core\Framework\Api\Exception\NoEntityClonedException;
use Laser\Core\Framework\Api\Exception\ResourceNotFoundException;
...
use Laser\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtection;
use Laser\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtectionValidator;
...
use Laser\Core\Framework\DataAbstractionLayer\Exception\MissingReverseAssociation;
...
class ApiController extends AbstractController
{
    ...
    private function resolveSearch(Request $request, Context $context, string $entityName, string $path): array
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Laser\Core\Content\Product\Definition\ProductPriceDefinition
             */
             ...
             * $definition:     \Laser\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition
             */
             ...
             * $definition:     \Laser\Core\Checkout\Order\Aggregate\OrderCustomer\OrderCustomerDefinition
             */
    ...
    private function getDefinitionOfPath(string $entityName, string $path, Context $context): EntityDefinition
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Laser\Core\Content\Category\CategoryDefinition
             */
