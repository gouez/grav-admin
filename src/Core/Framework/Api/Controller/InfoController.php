...
use Laser\Core\Content\Flow\Api\FlowActionCollector;
...
use Laser\Core\Framework\Api\ApiDefinition\Generator\OpenApi3Generator;
...
use Laser\Core\Maintenance\System\Service\AppUrlVerifier;
...
class InfoController extends AbstractController
{
    ...
    #[Route(path: '/api/_info/openapi3.json', defaults: ['auth_required' => '%laser.api.api_browser.auth_required_str%'], name: 'api.info.openapi3', methods: ['GET'])]
    ...
    #[Route(path: '/api/_info/open-api-schema.json', defaults: ['auth_required' => '%laser.api.api_browser.auth_required_str%'], name: 'api.info.open-api-schema', methods: ['GET'])]
    ...
    #[Route(path: '/api/_info/swagger.html', defaults: ['auth_required' => '%laser.api.api_browser.auth_required_str%'], name: 'api.info.swagger', methods: ['GET'])]
    ...
    {
        return new JsonResponse([
            'version' => $this->params->get('kernel.laser_version'),
            'versionRevision' => $this->params->get('kernel.laser_version_revision'),
            'adminWorker' => [
                'enableAdminWorker' => $this->params->get('laser.admin_worker.enable_admin_worker'),
                'enableQueueStatsWorker' => $this->params->get('laser.admin_worker.enable_queue_stats_worker'),
                'enableNotificationWorker' => $this->params->get('laser.admin_worker.enable_notification_worker'),
                'transports' => $this->params->get('laser.admin_worker.transports'),
            ],
            ...
            'settings' => [
                ...
                'private_allowed_extensions' => $this->params->get('laser.filesystem.private_allowed_extensions'),
            ],
        ]);
    }

    #[Route(path: '/api/_info/version', name: 'api.info.laser.version', methods: ['GET'])]
    #[Route(path: '/api/v1/_info/version', name: 'api.info.laser.version_old_version', methods: ['GET'])]
    public function infoLaserVersion(): JsonResponse
    {
        return new JsonResponse([
            'version' => $this->params->get('kernel.laser_version'),
        ]);
