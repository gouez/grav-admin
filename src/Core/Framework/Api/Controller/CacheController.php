...
use Laser\Storefront\Framework\Cache\CacheWarmer\CacheWarmer;
...
class CacheController extends AbstractController
{
    ...
    public function info(): JsonResponse
    {
        return new JsonResponse([
            ...
            'httpCache' => $this->container->get('parameter_bag')->has('laser.http.cache.enabled') && $this->getParameter('laser.http.cache.enabled'),
