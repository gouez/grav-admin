...
namespace Laser\Core\Framework\Api\ApiDefinition\Generator;

use http\Exception\RuntimeException;
use OpenApi\Annotations\OpenApi;
use OpenApi\Annotations\Operation;
use OpenApi\Annotations\Parameter;
use Laser\Core\Framework\Api\ApiDefinition\ApiDefinitionGeneratorInterface;
use Laser\Core\Framework\Api\ApiDefinition\DefinitionService;
use Laser\Core\Framework\Api\ApiDefinition\Generator\OpenApi\OpenApiDefinitionSchemaBuilder;
use Laser\Core\Framework\Api\ApiDefinition\Generator\OpenApi\OpenApiSchemaBuilder;
...
class StoreApiGenerator implements ApiDefinitionGeneratorInterface
{
    ...
    {
        $openApi->info->description = 'This endpoint reference contains an overview of all endpoints comprising the Laser Store API';
    }
