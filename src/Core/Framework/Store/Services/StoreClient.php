...
use Laser\Core\Framework\Store\Exception\StoreTokenMissingException;
...
use Laser\Core\Framework\Store\Struct\LicenseStruct;
...
use Laser\Core\Framework\Store\Struct\StoreActionStruct;
use Laser\Core\Framework\Store\Struct\StoreLicenseViolationStruct;
use Laser\Core\Framework\Store\Struct\StoreLicenseViolationTypeStruct;
use Laser\Core\Framework\Store\Struct\StoreUpdateStruct;
...
class StoreClient
{
    ...
    public function loginWithLaserId(string $laserId, string $password, Context $context): void
    {
    ...
    public function getPluginCompatibilities(Context $context, string $futureVersion, PluginCollection $pluginCollection): array
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'headers' => $this->getHeaders($context),
                'json' => [
                    'futureLaserVersion' => $futureVersion,
                    'plugins' => $pluginArray,
                ],
            ]
        );
    ...
    protected function getLaserVersion(): string
    {
        return $this->instanceService->getLaserVersion();
    }
