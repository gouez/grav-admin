...
use Laser\Core\Framework\Store\Event\FirstRunWizardFinishedEvent;
use Laser\Core\Framework\Store\Event\FirstRunWizardStartedEvent;
use Laser\Core\Framework\Store\Exception\LicenseDomainVerificationException;
use Laser\Core\Framework\Store\Exception\StoreLicenseDomainMissingException;
use Laser\Core\Framework\Store\Struct\AccessTokenStruct;
use Laser\Core\Framework\Store\Struct\DomainVerificationRequestStruct;
use Laser\Core\Framework\Store\Struct\FrwState;
use Laser\Core\Framework\Store\Struct\LicenseDomainCollection;
use Laser\Core\Framework\Store\Struct\LicenseDomainStruct;
use Laser\Core\Framework\Store\Struct\PluginCategoryStruct;
use Laser\Core\Framework\Store\Struct\PluginRecommendationCollection;
use Laser\Core\Framework\Store\Struct\PluginRegionCollection;
use Laser\Core\Framework\Store\Struct\PluginRegionStruct;
use Laser\Core\Framework\Store\Struct\ShopUserTokenStruct;
use Laser\Core\Framework\Store\Struct\StorePluginStruct;
...
class FirstRunWizardService
{
    ...
    public function frwLogin(string $laserId, string $password, Context $context): void
    {
        $accessTokenResponse = $this->frwClient->frwLogin($laserId, $password, $context);
