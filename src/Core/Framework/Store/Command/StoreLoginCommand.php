...
namespace Laser\Core\Framework\Store\Command;
...
class StoreLoginCommand extends Command
{
    ...
    {
        $this
            ->addOption('laserId', 'i', InputOption::VALUE_REQUIRED, 'Laser ID')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $laserId = $input->getOption('laserId');
        ...
        if ($laserId === null || $password === null) {
            throw new StoreInvalidCredentialsException();
        }

        try {
            $this->storeClient->loginWithLaserId($laserId, $password, $userContext);
