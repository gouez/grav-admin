...
namespace Laser\Core\Framework\Store\Api;
...
use Laser\Core\Framework\Store\Exception\StoreInvalidCredentialsException;
...
class StoreController extends AbstractController
{
    ...
    {
        $laserId = $request->request->get('laserId');
        $password = $request->request->get('password');

        if (!\is_string($laserId) || !\is_string($password)) {
            throw new StoreInvalidCredentialsException();
        }

        try {
            $this->storeClient->loginWithLaserId($laserId, $password, $context);
