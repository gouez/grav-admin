...
class EntityCompilerPass implements CompilerPassInterface
{
    ...
    private function collectDefinitions(ContainerBuilder $container): void
    {
        $entityNameMap = [];
        $repositoryNameMap = [];
        $services = $container->findTaggedServiceIds('laser.entity.definition');
    ...
    {
        $servicesIds = array_keys($container->findTaggedServiceIds('laser.field_serializer'));
    ...
    {
        $servicesIds = array_keys($container->findTaggedServiceIds('laser.field_resolver'));
    ...
    {
        $servicesIds = array_keys($container->findTaggedServiceIds('laser.field_accessor_builder'));
