...
namespace Laser\Core\Profiling;

use Laser\Core\Framework\Log\Package;
use Laser\Core\Profiling\Integration\ProfilerInterface;
...
{
    /**
     * Profilers will be activated over the laser.yaml file
     *
     ...
     * @return mixed
     */
    public static function trace(string $name, \Closure $closure, string $category = 'laser', array $tags = [])
    {
