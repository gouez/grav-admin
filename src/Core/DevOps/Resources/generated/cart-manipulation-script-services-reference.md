<!--- auto generated by `bin/console docs:generate-scripts-reference` in the laser project, don't edit this file manually -->
# Cart Manipulation script services reference

## [services.cart (`Laser\Core\Checkout\Cart\Facade\CartFacade`)](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/CartFacade.php) {#cartfacade}
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\ItemsFacade`](./cart-manipulation-script-services-reference.md#itemsfacade)
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\ProductsFacade`](./cart-manipulation-script-services-reference.md#productsfacade)
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\CartPriceFacade`](./cart-manipulation-script-services-reference.md#cartpricefacade)
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\ErrorsFacade`](./cart-manipulation-script-services-reference.md#errorsfacade)
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\StatesFacade`](./cart-manipulation-script-services-reference.md#statesfacade)
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\DiscountFacade`](./cart-manipulation-script-services-reference.md#discountfacade)
...
* **Examples:**
    * Add an absolute discount to the cart.
        ...
        {% raw %}
        ```twig
        {# @var services \Laser\Core\Framework\Script\ServiceStubs #}
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade) | `null`
...
_________
## [`Laser\Core\Checkout\Cart\Facade\CartPriceFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/CartPriceFacade.php) {#cartpricefacade}
...
* **Returns** [`Laser\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/laser/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        {% endraw %}
_________
## [`Laser\Core\Checkout\Cart\Facade\DiscountFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/DiscountFacade.php) {#discountfacade}
...
_________
## [`Laser\Core\Checkout\Cart\Facade\ErrorsFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ErrorsFacade.php) {#errorsfacade}
...
* **Returns** [`Laser\Core\Checkout\Cart\Error\Error`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Error/Error.php) | `null`
...
_________
## [`Laser\Core\Checkout\Cart\Facade\ItemFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ItemFacade.php) {#itemfacade}
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\PriceFacade`](./cart-manipulation-script-services-reference.md#pricefacade) | `null`
...
* **Returns** [`Laser\Core\Framework\Script\Facade\ArrayFacade`](./miscellaneous-script-services-reference.md#arrayfacade)
...
_________
## [`Laser\Core\Checkout\Cart\Facade\ItemsFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ItemsFacade.php) {#itemsfacade}
...
* **Returns** [`Laser\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade)

    Returns the added line-item.
* **Arguments:**
    * *[`Laser\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade)* **item**: The line-item that should be added.
* **Examples:**
    * Add an absolute discount to the cart.
...
* **Returns** `int`
    ...
    The number of line-items in this collection.
_________
## [`Laser\Core\Checkout\Cart\Facade\PriceFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFacade.php) {#pricefacade}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        {% endraw %}
_________
## [`Laser\Core\Checkout\Cart\Facade\ProductsFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ProductsFacade.php) {#productsfacade}
...
* **Returns** `int`
    ...
    The number of line-items in this collection.
_________
## [`Laser\Core\Checkout\Cart\Facade\StatesFacade`](https://github.com/laser/platform/blob/trunk/src/Core/Checkout/Cart/Facade/StatesFacade.php) {#statesfacade}
