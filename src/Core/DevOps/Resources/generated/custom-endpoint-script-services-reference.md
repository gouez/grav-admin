...
## [services.cache (`Laser\Core\Framework\Adapter\Cache\Script\Facade\CacheInvalidatorFacade`)](https://github.com/laser/platform/blob/trunk/src/Core/Framework/Adapter/Cache/Script/Facade/CacheInvalidatorFacade.php) {#cacheinvalidatorfacade}
...
* **Examples:**
    ...
    * Build tags if products with a specific property is created and invalidate those tags.
        ...
        {% endraw %}
_________
## [services.writer (`Laser\Core\Framework\DataAbstractionLayer\Facade\RepositoryWriterFacade`)](https://github.com/laser/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryWriterFacade.php) {#repositorywriterfacade}

The `writer` service allows you to write data, that is stored inside laser.
...
* **Returns** [`Laser\Core\Framework\DataAbstractionLayer\Event\EntityWrittenContainerEvent`](https://github.com/laser/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Event/EntityWrittenContainerEvent.php)
...
* **Returns** [`Laser\Core\Framework\Api\Sync\SyncResult`](https://github.com/laser/platform/blob/trunk/src/Core/Framework/Api/Sync/SyncResult.php)
...
* **Examples:**
    * Update an entity and delete another one with one `sync()` call.
        ...
        {% endraw %}
_________
## [services.response (`Laser\Core\Framework\Script\Api\ScriptResponseFactoryFacade`)](https://github.com/laser/platform/blob/trunk/src/Core/Framework/Script/Api/ScriptResponseFactoryFacade.php) {#scriptresponsefactoryfacade}
...
* **Returns** [`Laser\Core\Framework\Script\Api\ScriptResponse`](https://github.com/laser/platform/blob/trunk/src/Core/Framework/Script/Api/ScriptResponse.php)
