...
namespace Laser\Core\Content\Test\ContactForm;

use PHPUnit\Framework\TestCase;
use Laser\Core\Content\ContactForm\SalesChannel\ContactFormRoute;
...
class ContactFormServiceTest extends TestCase
{
    ...
    public function testContactFormSendMail(): void
    {
        ...
        $listenerClosure = function (MailSentEvent $event) use (&$eventDidRun, $phpunit): void {
            $eventDidRun = true;
            $phpunit->assertStringContainsString('Contact email address: test@laser.com', $event->getContents()['text/html']);
