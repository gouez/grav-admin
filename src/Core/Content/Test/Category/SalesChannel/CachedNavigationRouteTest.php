...
namespace Laser\Core\Content\Test\Category\SalesChannel;

use PHPUnit\Framework\TestCase;
use Laser\Core\Content\Category\Event\NavigationRouteCacheTagsEvent;
use Laser\Core\Content\Category\SalesChannel\NavigationRoute;
