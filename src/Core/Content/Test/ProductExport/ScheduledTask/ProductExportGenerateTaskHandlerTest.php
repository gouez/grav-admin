...
namespace Laser\Core\Content\Test\ProductExport\ScheduledTask;
...
use Laser\Core\Content\ProductExport\ScheduledTask\ProductExportGenerateTaskHandler;
...
class ProductExportGenerateTaskHandlerTest extends TestCase
{
    ...
    public function testGeneratedAtAndIntervalsAreRespected(): void
    {
        ...
        $bus = $this->getContainer()->get('messenger.bus.laser');
