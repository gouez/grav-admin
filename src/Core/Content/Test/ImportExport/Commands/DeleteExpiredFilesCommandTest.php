...
namespace Laser\Core\Content\Test\ImportExport\Commands;

use League\Flysystem\Filesystem;
use PHPUnit\Framework\TestCase;
use Laser\Core\Content\ImportExport\Aggregate\ImportExportFile\ImportExportFileEntity;
use Laser\Core\Content\ImportExport\Command\DeleteExpiredFilesCommand;
...
class DeleteExpiredFilesCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->filesystem = $this->getFilesystem('laser.filesystem.private');
    }
