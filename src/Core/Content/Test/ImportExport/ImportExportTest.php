...
use Laser\Core\Checkout\Promotion\Aggregate\PromotionDiscount\PromotionDiscountCollection;
...
use Laser\Core\Content\ImportExport\Event\ImportExportAfterImportRecordEvent;
use Laser\Core\Content\ImportExport\Event\ImportExportBeforeExportRecordEvent;
use Laser\Core\Content\ImportExport\Event\ImportExportBeforeImportRecordEvent;
use Laser\Core\Content\ImportExport\Event\ImportExportExceptionImportRecordEvent;
use Laser\Core\Content\ImportExport\Exception\UpdatedByValueNotFoundException;
use Laser\Core\Content\ImportExport\ImportExport;
use Laser\Core\Content\ImportExport\ImportExportProfileEntity;
use Laser\Core\Content\ImportExport\Processing\Pipe\AbstractPipe;
use Laser\Core\Content\ImportExport\Processing\Reader\AbstractReader;
use Laser\Core\Content\ImportExport\Processing\Reader\CsvReader;
...
use Laser\Core\Content\ImportExport\Service\ImportExportService;
...
use Laser\Core\Content\Newsletter\SalesChannel\NewsletterSubscribeRoute;
...
use Laser\Core\Content\Product\Aggregate\ProductCrossSellingAssignedProducts\ProductCrossSellingAssignedProductsCollection;
use Laser\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition;
use Laser\Core\Content\Product\Aggregate\ProductMedia\ProductMediaCollection;
...
use Laser\Core\Content\Product\Aggregate\ProductVisibility\ProductVisibilityCollection;
...
class ImportExportTest extends AbstractImportExportTestCase
{
    ...
    public function testExportEvents(): void
    {
        ...
        $filesystem = $this->getContainer()->get('laser.filesystem.private');
    ...
    public function testCustomersCsv(): void
    {
        ...
        static::assertSame('laser AG', $customerWithMultipleAddresses->getDefaultBillingAddress()->getCompany());
        ...
        static::assertSame('laser AG', $customerWithUpdatedAddresses->getDefaultShippingAddress()->getCompany());
        ...
        static::assertStringContainsString('laser AG', $csv);
