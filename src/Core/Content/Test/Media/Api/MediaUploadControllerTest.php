...
use Laser\Core\Content\Media\Event\MediaUploadedEvent;
 ...
 *
 * @covers \Laser\Core\Content\Media\Api\MediaUploadController
 */
class MediaUploadControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        \copy(self::TEST_IMAGE, $this->getContainer()->getParameter('kernel.project_dir') . '/public/media/laser-logo.png');
    }

    protected function tearDown(): void
    {
        \unlink($this->getContainer()->getParameter('kernel.project_dir') . '/public/media/laser-logo.png');
    ...
    public function testUploadFromURL(): void
    {
        ...
        $baseUrl = EnvironmentHelper::getVariable('APP_URL') . '/media/laser-logo.png';
