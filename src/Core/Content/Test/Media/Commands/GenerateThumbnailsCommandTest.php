...
namespace Laser\Core\Content\Test\Media\Commands;

use PHPUnit\Framework\TestCase;
use Laser\Core\Content\Media\Aggregate\MediaThumbnail\MediaThumbnailEntity;
use Laser\Core\Content\Media\Commands\GenerateThumbnailsCommand;
use Laser\Core\Content\Media\MediaEntity;
use Laser\Core\Content\Media\Message\UpdateThumbnailsMessage;
...
use Laser\Core\Framework\Test\TestCaseBase\CommandTestBehaviour;
use Laser\Core\Framework\Test\TestCaseBase\IntegrationTestBehaviour;
use Laser\Core\Test\CollectingMessageBus;
...
class GenerateThumbnailsCommandTest extends TestCase
{
    ...
    protected function createValidMediaFiles(): void
    {
        ...
        $this->getPublicFilesystem()->writeStream(
            $filePath,
            fopen(__DIR__ . '/../fixtures/laser-logo.png', 'rb')
        );

        $filePath = $this->urlGenerator->getRelativeMediaUrl($mediaJpg);
        $this->getPublicFilesystem()->writeStream(
            $filePath,
            fopen(__DIR__ . '/../fixtures/laser.jpg', 'rb')
        );
    }
    ...
    protected function createNotSupportedMediaFiles(): void
    {
        ...
        $filePath = $this->urlGenerator->getRelativeMediaUrl($mediaJpg);
        $this->getPublicFilesystem()->writeStream($filePath, fopen(__DIR__ . '/../fixtures/laser.jpg', 'rb'));
    }
