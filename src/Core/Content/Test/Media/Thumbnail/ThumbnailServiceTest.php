...
namespace Laser\Core\Content\Test\Media\Thumbnail;
...
use Laser\Core\Content\Media\Aggregate\MediaThumbnailSize\MediaThumbnailSizeEntity;
use Laser\Core\Content\Media\Exception\ThumbnailNotSupportedException;
...
class ThumbnailServiceTest extends TestCase
{
    ...
    public function testThumbnailGeneration(): void
    {
        ...
        $resource = fopen(__DIR__ . '/../fixtures/laser-logo.png', 'rb');
    ...
    public function testItUsesOriginalImageIfItsSmallerThanGeneratedThumbnail(): void
    {
        ...
        $filePath = $this->urlGenerator->getRelativeMediaUrl($media);
        $resource = fopen(__DIR__ . '/../fixtures/laser_optimized.jpg', 'rb');
        \assert($resource !== false);
        $this->getPublicFilesystem()->writeStream($filePath, $resource);
    ...
    public function testItUsesFolderConfigGenerateThumbnails(): void
    {
        ...
        $filePath = $this->urlGenerator->getRelativeMediaUrl($media);
        $resource = fopen(__DIR__ . '/../fixtures/laser.jpg', 'rb');
