...
use Laser\Core\Content\Cms\SalesChannel\Struct\ImageSliderStruct;
use Laser\Core\Content\Media\Cms\DefaultMediaResolver;
use Laser\Core\Content\Media\Cms\Type\ImageSliderTypeDataResolver;
...
class ImageSliderTypeDataResolverTest extends TestCase
{
    ...
    public function testEnrichWithDefaultConfig(): void
    {
        ...
        $medias = [
            ...
            ['fileName' => 'core/assets/default/cms/laser.jpg'],
        ];
        ...
        static::assertEquals('laser', $secondSliderItemMedia->getFileName());
