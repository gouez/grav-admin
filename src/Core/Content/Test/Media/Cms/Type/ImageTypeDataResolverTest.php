...
namespace Laser\Core\Content\Test\Media\Cms\Type;
...
use Laser\Core\Content\Media\Cms\ImageCmsElementResolver;
...
class ImageTypeDataResolverTest extends TestCase
{
    ...
    public function testEnrichWithUrlOnly(): void
    {
        ...
        $fieldConfig = new FieldConfigCollection();
        $fieldConfig->add(new FieldConfig('url', FieldConfig::SOURCE_STATIC, 'http://laser.com/image.jpg'));

        $slot = new CmsSlotEntity();
        $slot->setUniqueIdentifier('id');
        $slot->setType('image');
        $slot->setConfig(['url' => 'http://laser.com/image.jpg']);
        $slot->setFieldConfig($fieldConfig);
        ...
        $imageStruct = $slot->getData();
        static::assertInstanceOf(ImageStruct::class, $imageStruct);
        static::assertSame('http://laser.com/image.jpg', $imageStruct->getUrl());
        static::assertEmpty($imageStruct->getMedia());
        static::assertEmpty($imageStruct->getMediaId());
    }
    ...
    public function testEnrichWithMediaAndUrl(): void
    {
        ...
        $slot->setUniqueIdentifier('id');
        $slot->setType('image');
        $slot->setConfig(['mediaId' => 'media123', 'url' => 'http://laser.com/image.jpg']);
        $slot->setFieldConfig($fieldConfig);
    ...
    public function testEnrichWithDefaultConfig(): void
    {
        ...
        $fieldConfig = new FieldConfigCollection();
        $fieldConfig->add(new FieldConfig('media', FieldConfig::SOURCE_DEFAULT, 'core/assets/default/cms/laser.jpg'));
    ...
    public function testUrlWithLocal(): void
    {
        ...
        $manufacturer->setLink('http://laser.com');
