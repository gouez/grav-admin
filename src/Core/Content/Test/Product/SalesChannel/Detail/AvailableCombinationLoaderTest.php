...
use Laser\Core\Content\Product\SalesChannel\Detail\AbstractAvailableCombinationLoader;
use Laser\Core\Content\Product\SalesChannel\Detail\AvailableCombinationLoader;
