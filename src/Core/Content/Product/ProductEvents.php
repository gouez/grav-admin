...
{
    /**
     * @Event("Laser\Core\Content\Product\Events\ProductListingCriteriaEvent")
     */
    final public const PRODUCT_LISTING_CRITERIA = ProductListingCriteriaEvent::class;

    /**
     * @Event("Laser\Core\Content\Product\Events\ProductSuggestCriteriaEvent")
     */
    final public const PRODUCT_SUGGEST_CRITERIA = ProductSuggestCriteriaEvent::class;

    /**
     * @Event("Laser\Core\Content\Product\Events\ProductSearchCriteriaEvent")
     */
    final public const PRODUCT_SEARCH_CRITERIA = ProductSearchCriteriaEvent::class;

    /**
     * @Event("Laser\Core\Content\Product\Events\ProductListingResultEvent")
     */
    final public const PRODUCT_LISTING_RESULT = ProductListingResultEvent::class;

    /**
     * @Event("Laser\Core\Content\Product\Events\ProductSuggestResultEvent")
     */
    final public const PRODUCT_SUGGEST_RESULT = ProductSuggestResultEvent::class;

    /**
     * @Event("Laser\Core\Content\Product\Events\ProductSearchResultEvent")
     */
    final public const PRODUCT_SEARCH_RESULT = ProductSearchResultEvent::class;

    /**
     * @Event("Laser\Core\Content\Product\Events\ProductIndexerEvent")
     */
