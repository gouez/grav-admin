...
use Laser\Core\Content\Product\Exception\ProductLineItemDifferentIdException;
use Laser\Core\Content\Product\Exception\ProductLineItemInconsistentException;
