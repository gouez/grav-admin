...
use Laser\Core\Content\Mail\Service\AbstractMailService;
use Laser\Core\Content\Mail\Service\MailAttachmentsConfig;
use Laser\Core\Content\MailTemplate\Exception\MailEventConfigurationException;
use Laser\Core\Content\MailTemplate\Exception\SalesChannelNotFoundException;
