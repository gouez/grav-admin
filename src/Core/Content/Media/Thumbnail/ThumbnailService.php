...
namespace Laser\Core\Content\Media\Thumbnail;
...
use Laser\Core\Content\Media\Exception\ThumbnailCouldNotBeSavedException;
...
use Laser\Core\Content\Media\Subscriber\MediaDeletionSubscriber;
