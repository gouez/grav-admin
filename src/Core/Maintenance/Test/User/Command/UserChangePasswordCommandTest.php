...
namespace Laser\Core\Maintenance\Test\User\Command;
...
use Laser\Core\Maintenance\User\Command\UserChangePasswordCommand;
...
class UserChangePasswordCommandTest extends TestCase
{
    ...
    private const TEST_USERNAME = 'laser';
    private const TEST_PASSWORD = 'laserPassword';
