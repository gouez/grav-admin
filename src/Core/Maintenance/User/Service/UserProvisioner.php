...
namespace Laser\Core\Maintenance\User\Service;

use Doctrine\DBAL\Connection;
use Laser\Core\Defaults;
use Laser\Core\Framework\DataAbstractionLayer\Field\PasswordField;
use Laser\Core\Framework\DataAbstractionLayer\FieldSerializer\PasswordFieldSerializer;
...
class UserProvisioner
{
    ...
    public function provision(string $username, ?string $password = null, array $additionalData = []): string
    {
        ...
        $userPayload = [
            ...
            'email' => $additionalData['email'] ?? 'info@laser.com',
            'username' => $username,
