...
namespace Laser\Core\Maintenance\System\Command;
...
#[AsCommand(
    name: 'system:install',
    description: 'Installs the Laser 6 system',
)]
#[Package('core')]
class SystemInstallCommand extends Command
{
    ...
    {
        $output = new LaserStyle($input, $output);
    ...
    private function initializeDatabase(LaserStyle $output, InputInterface $input): void
    {
        ...
        $importedBaseSchema = $this->setupDatabaseAdapter->initializeLaserDb($connection, $databaseConnectionInformation->getDatabaseName());
