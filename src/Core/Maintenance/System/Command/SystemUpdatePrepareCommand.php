...
class SystemUpdatePrepareCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $currentVersion = $this->container->getParameter('kernel.laser_version');
        if (!\is_string($currentVersion)) {
            throw new \RuntimeException('Container parameter "kernel.laser_version" needs to be a string');
        }
