...
use Laser\Core\Framework\Update\Api\UpdateController;
use Laser\Core\Framework\Update\Event\UpdatePostFinishEvent;
use Laser\Core\Framework\Update\Event\UpdatePreFinishEvent;
...
class SystemUpdateFinishCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $newVersion = $containerWithoutPlugins->getParameter('kernel.laser_version');
