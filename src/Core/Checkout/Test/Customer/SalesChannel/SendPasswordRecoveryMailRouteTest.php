...
use Laser\Core\Checkout\Customer\Event\PasswordRecoveryUrlEvent;
...
class SendPasswordRecoveryMailRouteTest extends TestCase
{
    ...
    {
        $this->createCustomer('laser1234', 'foo-test@test.de');
    ...
    public function testResetWithDisabledAccount(): void
    {
        ...
        $this->createCustomer('laser1234', $email, false);
