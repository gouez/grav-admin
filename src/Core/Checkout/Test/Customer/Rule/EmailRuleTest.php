...
use Laser\Core\Checkout\Customer\Rule\EmailRule;
...
class EmailRuleTest extends TestCase
{
    ...
    public static function getMatchValues(): \Traversable
    {
        ...
        yield 'operator_eq / not match partially start / email' => [Rule::OPERATOR_EQ, 'test@example.com', '*@laser.com', false];
        ...
        yield 'operator_neq / not match partially start / email' => [Rule::OPERATOR_NEQ, 'test@example.com', '*@laser.com', true];
