...
use Laser\Core\Checkout\DependencyInjection\CompilerPass\CartRedisCompilerPass;
...
class Checkout extends Bundle
{
    ...
    public function build(ContainerBuilder $container): void
    {
        ...
        if ($container->getParameter('kernel.environment') === 'test' && class_exists('Laser\Tests\Unit\Core\Checkout\Cart\TaxProvider\_fixtures\TestConstantTaxRateProvider')) {
