...
namespace Laser\Core\Checkout\Promotion\Util;

use Doctrine\DBAL\Connection;
use Laser\Core\Checkout\Promotion\Exception\PatternAlreadyInUseException;
use Laser\Core\Checkout\Promotion\Exception\PatternNotComplexEnoughException;
