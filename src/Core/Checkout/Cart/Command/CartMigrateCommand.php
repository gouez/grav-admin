...
namespace Laser\Core\Checkout\Cart\Command;
...
use Laser\Core\Framework\DataAbstractionLayer\Command\ConsoleProgressTrait;
use Laser\Core\Framework\DataAbstractionLayer\Dbal\Common\LastIdQuery;
...
class CartMigrateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($this->redis === null) {
            throw new \RuntimeException('%laser.cart.redis_url% is not configured and no url provided.');
        }
