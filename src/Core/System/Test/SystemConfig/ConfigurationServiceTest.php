...
namespace Laser\Core\System\Test\SystemConfig;

use PHPUnit\Framework\TestCase;
use Laser\Core\Framework\App\Lifecycle\AppLoader;
use Laser\Core\Framework\Context;
use Laser\Core\Framework\Log\Package;
use Laser\Core\Framework\Test\TestCaseBase\IntegrationTestBehaviour;
use Laser\Core\System\SystemConfig\Exception\BundleConfigNotFoundException;
use Laser\Core\System\SystemConfig\Exception\ConfigurationNotFoundException;
...
class ConfigurationServiceTest extends TestCase
{
                ...
                'elements' => [
                    [
                        ...
                        'config' => [
                            ...
                            'defaultValue' => 'no-reply@laser.de',
                        ],
                    ],
                ],
            ],
    ...
    public function testGetResolvedConfigurationFromAppChanged(): void
    {
        ...
        $systemConfigService->set('SwagAppConfig.config.email', 'changed@laser.de');
