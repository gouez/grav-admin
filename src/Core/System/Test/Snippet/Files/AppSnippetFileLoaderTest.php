...
use Laser\Core\System\Snippet\Files\AppSnippetFileLoader;
use Laser\Core\System\Snippet\Files\SnippetFileCollection;
use Laser\Core\System\Snippet\Files\SnippetFileLoader;
...
class AppSnippetFileLoaderTest extends TestCase
{
    ...
    public function testLoadSnippetFilesIntoCollection(): void
    {
        ...
        static::assertEquals('laser AG', $snippetFile->getAuthor());
