...
class StoreApiInfoController
{
    ...
    #[Route(path: '/store-api/_info/openapi3.json', defaults: ['auth_required' => '%laser.api.api_browser.auth_required_str%'], name: 'store-api.info.openapi3', methods: ['GET'])]
    ...
    #[Route(path: '/store-api/_info/open-api-schema.json', defaults: ['auth_required' => '%laser.api.api_browser.auth_required_str%'], name: 'store-api.info.open-api-schema', methods: ['GET'])]
    ...
    #[Route(path: '/store-api/_info/swagger.html', defaults: ['auth_required' => '%laser.api.api_browser.auth_required_str%'], name: 'store-api.info.swagger', methods: ['GET'])]
