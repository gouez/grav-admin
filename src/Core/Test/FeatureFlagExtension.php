...
use Laser\Core\Test\Annotation\DisabledFeatures;
use Laser\Tests\Unit\Core\Test\FeatureFlagExtensionTest;
...
class FeatureFlagExtension implements BeforeTestHook, AfterTestHook
{
    ...
    public function __construct(
        private readonly string $namespacePrefix = 'Laser\\Tests\\Unit\\',
