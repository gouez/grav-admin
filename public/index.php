...
use Laser\Core\Installer\InstallerKernel;
...
return function (array $context) {
    ...
    $laserHttpKernel = new HttpKernel($appEnv, $debug, $classLoader);

    return new class($laserHttpKernel) implements HttpKernelInterface, TerminableInterface {
